...
To run GVCCS-linked tests, set `ML_AUTORESEARCH_GVCCS_PROBLEM_ROOT` and `ML_AUTORESEARCH_TEST_PROBLEM_ROOT` to your external package roots before invoking the test suite.
Any GVCCS-named Python wrappers are legacy compatibility shims around generic Research Problem dispatch.
