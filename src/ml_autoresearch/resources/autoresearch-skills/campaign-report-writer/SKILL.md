...
Use at scheduled checks, before pauses, or when humans need compact campaign status. Write a Campaign Report and record it with `record-campaign-report`; if pausing, use `pause-campaign` after the report.
