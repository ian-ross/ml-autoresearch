...
Use after Experiment Proposal approval to create or repair a Candidate Experiment under the Candidate Experiment Contract, including `manifest.yaml`, `model.py`, optional helpers, README, and required autonomous-mode `PROPOSAL.md`.
