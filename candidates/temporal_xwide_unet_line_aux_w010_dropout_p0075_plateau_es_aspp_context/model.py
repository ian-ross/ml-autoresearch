"""Temporal channel-stacked extra-wide U-Net with dilated bottleneck context and line auxiliary logits."""
...
class ExtraWideContextUNet(nn.Module):
    """Base-64 encoder/decoder with p=0.075 bottleneck dropout, context block, and mask/line heads."""
...
def build_model(input_spec: dict, output_spec: dict) -> nn.Module:
    candidate_name = "temporal_xwide_unet_line_aux_w010_dropout_p0075_plateau_es_aspp_context"
