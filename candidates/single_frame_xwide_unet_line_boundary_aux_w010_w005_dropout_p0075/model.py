"""Extra-wide U-Net-style Candidate Experiment with line and boundary auxiliary logits."""
...
def build_model(input_spec: dict, output_spec: dict) -> nn.Module:
    if input_spec["mode"] != "single_frame_rgb":
        raise ValueError("single_frame_xwide_unet_line_boundary_aux_w010_w005_dropout_p0075 requires single_frame_rgb input")
    if output_spec["form"] != "mask_logits":
        raise ValueError("single_frame_xwide_unet_line_boundary_aux_w010_w005_dropout_p0075 produces mask_logits output")
    ...
    if auxiliary_outputs != expected_auxiliary:
        raise ValueError("single_frame_xwide_unet_line_boundary_aux_w010_w005_dropout_p0075 requires line_logits and boundary_logits auxiliary outputs")
