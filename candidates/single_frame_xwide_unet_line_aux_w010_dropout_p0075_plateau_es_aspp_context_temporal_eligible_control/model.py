"""Extra-wide U-Net with lightweight dilated bottleneck context and line auxiliary logits."""
...
def build_model(input_spec: dict, output_spec: dict) -> nn.Module:
    candidate_name = "single_frame_xwide_unet_line_aux_w010_dropout_p0075_plateau_es_aspp_context_temporal_eligible_control"
