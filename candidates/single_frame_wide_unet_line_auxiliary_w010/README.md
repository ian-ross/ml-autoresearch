# single_frame_wide_unet_line_auxiliary_w010

Wider single-frame U-Net Candidate Experiment for Ground-Camera Contrail Detection.

## Model Architecture

- Single-frame RGB U-Net with three downsampling stages.
- Base channel width 48, doubling through the encoder to a 384-channel bottleneck.
...
- Requested batch size 12, max epochs 30.
...
The wider model may overfit or consume more GPU memory than the base-32 comparison target. The requested lower batch size is intended to reduce resource pressure while keeping the experiment within allowed training knobs.
