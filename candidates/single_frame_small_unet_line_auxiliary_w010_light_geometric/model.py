...
def build_model(input_spec: dict, output_spec: dict) -> nn.Module:
    if input_spec["mode"] != "single_frame_rgb":
        raise ValueError("single_frame_small_unet_line_auxiliary_w010_light_geometric requires single_frame_rgb input")
    if output_spec["form"] != "mask_logits":
        raise ValueError("single_frame_small_unet_line_auxiliary_w010_light_geometric produces mask_logits output")
    ...
    if auxiliary_outputs != expected_auxiliary:
        raise ValueError("single_frame_small_unet_line_auxiliary_w010_light_geometric requires line_logits auxiliary output")
