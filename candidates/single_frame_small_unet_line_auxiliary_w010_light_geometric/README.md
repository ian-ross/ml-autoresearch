# single_frame_small_unet_line_auxiliary_w010_light_geometric
...
This variant isolates the Harness-owned `light_geometric` Augmentation Policy after the broader `light_combined` augmentation preset regressed. It keeps architecture, losses, optimizer, learning rate, batch size, max epochs, and deterministic shuffle unchanged relative to `single_frame_small_unet_line_auxiliary_w010`.
...
- `data.augmentation_policy: light_geometric`
